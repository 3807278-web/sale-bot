  ...
  return (
    <div style={{maxWidth:480,margin:"0 auto",fontFamily:"sans-serif",paddingBottom:70}}>
      ...
      <div style={{position:"fixed",bottom:0,left:0,right:0,display:"flex",borderTop:"1px solid #eee",background:"white"}}>
        <button onClick={() => setPage("offers")} style={{flex:1,padding:16,border:"none",background:"none",color:page==="offers"?"#0088cc":"#888",fontWeight:"bold",fontSize:16,cursor:"pointer"}}>🏷️Знайти Акцію</button>
